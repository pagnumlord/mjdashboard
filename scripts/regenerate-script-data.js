...
const taskDefs = [
  ...
  ['Post-Production', 'Sound', 'Compose Yori Takahashi melody theme (recurring)'],
  ['Post-Production', 'Sound', 'Compose Melodic Justice band songs (3 + practice variations)'],
  ['Post-Production', 'Sound', 'Compose Shadow / Black Sun motif'],
  ['Post-Production', 'Sound', 'Compose Dr. White motif'],
